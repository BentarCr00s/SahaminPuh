            ...
            <div class="menu-kalkulator-container p-3">
                <ul class="menu-kalkulator list-group">
                    <li class="list-group-item ">
                        <button class="menu-item btn btn-transparent btn-block hover-bg-lightgray" data-target=".hitungProfit-container">Capital Gains</button>
                    </li>
                    <li class="list-group-item">
                        <button class="menu-item btn btn-transparent btn-block hover-bg-lightgray" data-target=".averageSaham-container">Average Saham</button>
                    </li>
                    <li class="list-group-item">
                        <button class="menu-item btn btn-transparent btn-block hover-bg-lightgray" data-target=".marginSafety-container">Margin of Safety</button>
                    </li>
                    <li class="list-group-item">
                        <button class="menu-item btn btn-transparent btn-block hover-bg-lightgray" data-target=".hargaWajar-container">Harga Wajar Saham</button>
                    </li>
                </ul>
            </div>
        </aside>
